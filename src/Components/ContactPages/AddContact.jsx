...
class AddContact extends React.Component {
    ...
    handleAddContactSubmitForm = (e) => {
        ...
        if (this.props.isUpdating) {
           response = this.props.handleUpdatingContact(
    ...
    return (
      <div className="col-12 border border-5 p-2">
        <form onSubmit={this.handleAddContactSubmitForm} className="contact-form">
              <input
                hidden
                name="contactId"
          ...
          <div className="row p-2">
            ...
            <div className
              ={`col-12 p-1 ${this.props.isUpdating ? "col-md-4 offset-md-2" : "col-md-6 offset-md-3"}`}>
